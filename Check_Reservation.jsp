 ...
 if(que.next())
{
            ...
            fn=que.getString("Flight_No");
            fnam=que.getString("Flight_Name");
            dd=que.getString("Departure_Date");
            dt=que.getString("Departure_Time");
            rd=que.getString("Reservations_Date");
            rty=que.getString("Reservations_type");
            }            
que.close();
state.close();
}
     ...
     <tbody><tr><td>  
        ...
        <tbody><tr><td style="font-size: 20px;" align="center" height="auto" width="auto">
         <div  style="float:left;"><font face="Arial" color="red" >
             <span><b>Airline Tickets  Reservations Condition Form</b></span></font></div></td></tr></tbody></table>
                            
<table valign="top" align="center" border="0" cellpadding="0" cellspacing="0" width="550">
        <tbody><tr><td>To check your reservation condition,Please fill out all fields marked with*.</td></tr></tbody></table>
                 
         <div><table width="100%" border="0" cellpadding="2" cellspacing="0">
    <tbody><tr><td colspan="2" bgcolor="E61606">
        <div  style="color: white">
<b>&nbsp;&nbsp;Reservation condition form:</b></div></td></tr>
...
<table valign="top" align="center" border="0" cellpadding="0" cellspacing="0" width="580">
 ...
 <tr><td align="right"> Name:</td>
            <td><input size="30" value="<%=nam%>"name="f_name" maxlength="40" type="text" readonly></td></tr>  
        
              <tr><td align="right">Flight Number:</td>
                  <td><input size="30" value="<%=fn%>" name="Flight_Number" maxlength="40" type="text" readonly></td></tr>
              
              <tr><td align="right">Flight Name:</td>
                  <td><input size="30" value="<%=fnam%>" name="Flight_Name" maxlength="40" type="text" readonly></td></tr>
              
              <tr><td align="right">Departure Date:</td>
                  <td><input size="30" value="<%=dd%>" name="Reservations_Number" maxlength="40" type="text" readonly></td></tr>
              
              <tr><td align="right">Departure Time:</td>
                  <td><input size="30" value="<%=dt%>" name="Reservations_Number" maxlength="40" type="text" readonly></td></tr>
              
              <tr><td align="right">Reservations Date:</td>
                  <td><input size="30" value="<%=rd%>" name="Reservations_Number" maxlength="40" type="text" readonly></td></tr>
              
              <tr><td align="right">Reservations Type:</td>
                  <td><input size="30" value="<%=rty%>" name="Reservations_Number" maxlength="40" type="text" readonly></td></tr>
