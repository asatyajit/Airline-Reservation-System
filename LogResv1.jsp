...
<body background="Images/backgrnd[2].gif" link="#669900" vlink="#999933" alink="#FF9900" leftmargin="1" topmargin="1" marginheight="1" marginwidth="1">
    ...
    <tbody><tr><td align="center" width="auto" height="10"></td></tr>
                            ...
                            <form name="f1" method="post" action="LogResv.jsp"> 
                     
              <tr><td colspan="3" align="center">
             <input name="A2" value="&nbsp;&nbsp; Forward Page &nbsp;&nbsp;" input type="submit"></td></tr>
...
Statement st=con.createStatement();
            ...
            <td align="center"><b>Reservations No</b></td>
            <td align="center"><b>Flight No</b></td>
            <td align="center"><b>Flight Name</b></td>
            <td align="center"><b>Departure Time</b></td>
            <td align="center"><b>Departure Date</b></td>
            <td align="center"><b>Reservations Date</b></td></tr> 
 <%
 ...
 while(rs.next())
    ...
    %>               
     ...
     <tr height="25" width="930">
            <td align="center"><%=rs.getString("f_From")%></td>
            <td align="center"><%=rs.getString("f_To")%></td>
            <td align="center"><%=rs.getString("Paytype")%></td>
            <td align="center"><%=rs.getString("pay_no")%></td>
            <td align="center"><%=rs.getString("Payment")%></td>
            <td align="center"><%=rs.getString("Comments")%></td>
            <td align="center"><%=rs.getString("Ticket_No")%></td>
            <td align="center"><%=rs.getString("Reservations_No")%></td>
            ...
            <td align="center"><%=rs.getString("Departure_Date")%></td>
            <td align="center"><%=rs.getString("Reservations_Date")%></td></tr>
<%
                }
rs.close();
st.close();
con.close();  
    ...
    <tbody><tr><td align="center" width="auto" height="10"></td></tr>
     ...
     <tr><td colspan="3" align="center">
             <input name="A3" value="&nbsp;&nbsp; Forward Page &nbsp;&nbsp;" input type="submit"></td></tr>
                 </form>
