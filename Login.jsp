...
<body background="Images/backgrnd[2].gif" link="#669900" vlink="#999933" alink="#FF9900" leftmargin="1" topmargin="1" marginheight="1" marginwidth="1">
                 ...
                 <%                 
String lna1=request.getParameter("lna");    
String lid1=request.getParameter("lid");
String lpw1=request.getParameter("lpw");
String lid2="";
String lpw2="";
...
ResultSet que1=state.executeQuery("select * from Register where RPass='"+lpw1+"'");
 if(que1.next())
{
            lid2=que1.getString("RID");
            lpw2=que1.getString("RPass");         
}
que1.close();

if (lpw1.equals(lpw2) || lid1.equals(lid2))
 {
  ...
  try
      {   
state.executeUpdate("insert into Register(RName,RID,RPass) "
        + "values('"+lna1+"','"+lid1+"','"+lpw1+"')");  
 ...
 <tr><td><img src="Images/airplane.gif" height="230" width="100%"></img> </td></tr>
     ...
     <tbody><tr><td>  
        ...
        <tbody><tr><td style="font-size: 20px;" align="center" height="auto" width="auto">
         <div  style="float:inherit;"><font face="Arial" color="violet" >
             <b>Airline Reservations Administrator Login Form</b>
            </font></div></td></tr></tbody></table>
                            
<table valign="top" align="center" border="0" cellpadding="0" cellspacing="0" width="550">
        <tbody><tr><td>Please fill out all fields marked with*.
            </td></tr></tbody></table>
                 
         <div><table width="100%" border="0" cellpadding="2" cellspacing="0">
    <tbody><tr><td colspan="2" bgcolor="violet">
        <div  style="color: white">
            <b>&nbsp;&nbsp;&nbsp;If you are already a member, enter your Login ID and Password :</b></div></td></tr></tbody></table></div>

                 <form name="f1" method="post" action="ADM.jsp">
      ...
      <table valign="top" align="center" border="0" cellpadding="0" cellspacing="0" width="580">
        <tbody><tr><td> &nbsp;</td></tr>
         ...
         <div style="float:none;"><font face="Arial">
            <blink><b>This ID Already Present...</b></blink>
            </font></div></td></tr></tbody></table>      
  <%
   }                  
 else if(lpw1.equals(lpw3))
           {
    %>                 
      <table valign="top" align="center" border="0" cellpadding="0" cellspacing="0" width="580">
        <tbody><tr><td> &nbsp;</td></tr>
         ...
         <tr><td style="font-size: 24px;" align="center" height="auto" width=100%>
         <div style="float:none;"><font face="Arial">
            <blink><b>This Password Already Present...</b></blink>
            </font></div></td></tr></tbody></table>     
  <%
   }      
   else 
    ...
    %> 
     ...
     <table valign="top" align="center" border="0" cellpadding="0" cellspacing="0" width="580">
        <tbody><tr><td> &nbsp;</td></tr>
         ...
         <tr><td style="font-size: 24px;" align="center" height="auto" width=100%>
         <div style="float:none;"><font face="Arial">
            <blink><b>Successful Your Registration...</b></blink>
            </font></div></td></tr></tbody></table>  
    
        <table width="100%" border="0" cellpadding="2" cellspacing="1">
    <tbody><tr><td>&nbsp;</td></tr>
        <tr><td align="right">* Login ID:</td>
        <td><input size="30" name="lid22" maxlength="40" type="text"></td></tr>
      
      <tr><td align="right">* Password:</td>
          <td><input size="30" name="lpw22" maxlength="40" type="password">
              </td></tr>
    
<tr><td colspan="4">
<span style="display:inline-block;color:Red;font-weight:bold;width:456px;"></span></td></tr>

<tr><td colspan="3" align="center" border="1">
    <input name="A3" value="&nbsp; Submit &nbsp; " input type="submit" onclick="">
                   <input value="&nbsp; Reset &nbsp; " input type="reset"></td></tr>
     <%
   }

    %>
<tr><td colspan="4" align="left" height="22">
...
<a href="Register.html" style="text-decoration: none;">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Register Now</a>
<span>and continue using Airline Reservation System</span></td></tr>
