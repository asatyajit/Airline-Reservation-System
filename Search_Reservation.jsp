...
ResultSet que=state.executeQuery("select * from Reservation where Name='"+fn+"' and Passport_Number='"+pap+"'");
 if(que.next())
{
     fn1=que.getString("Name");           
     pap1=que.getString("Passport_Number");
     rtno=que.getString("Reservations_No");           
     ton=que.getString("Ticket_No");       
}
que.close();
     ...
     <tbody><tr><td>  
        ...
        <tbody><tr><td style="font-size: 20px;" align="center" height="auto" width="auto">
         <div  style="float:left;"><font face="Arial" color="red" >
             <span><b>Airline Reservations Number Search Form</b></span>
            </font></div></td></tr></tbody></table>
                            
<table valign="top" align="center" border="0" cellpadding="0" cellspacing="0" width="550">
        <tbody><tr><td>To search your airline reservations number,
    ...
    <tbody><tr><td colspan="2" bgcolor="E61606">
        <div  style="color: white">
            <b>&nbsp;&nbsp;Reservation Number Search:</b></div></td></tr></tbody></table></div>
      ...
      <table valign="top" align="center" border="0" cellpadding="0" cellspacing="0" width="580">
        <tbody><tr><td> &nbsp;</td></tr>
         ...
         <div style="float:none;"><font face="Arial">
            <blink><b>Your Name Is Error...</b></blink>
            </font></div></td></tr></tbody></table>      
  <%
   }
 if(pap1==pap || pap1=="")
    ...
    %>     
      <table valign="top" align="center" border="0" cellpadding="0" cellspacing="0" width="580">
        <tbody><tr><td> &nbsp;</td></tr>
         ...
         <tr><td style="font-size: 24px;" align="center" height="auto" width=100%>
         <div style="float:none;"><font face="Arial">
            <blink><b>Your Passport Number Is Error...</b></blink>
            </font></div></td></tr></tbody></table>     
  <%
   }
       else 
    ...
    <tbody> <tr><td> &nbsp;</td></tr>
         <tr><td align="right">Ticket Number:</td>
              <td><input size="30" value="<%=ton%>" name="Ticket_Number1" maxlength="40" type="text" readonly></td></tr>
              
              <tr><td align="right">Reservations Number:</td>
                  <td><input size="30" value="<%=rtno%>" name="Reservations_Number1" maxlength="40" type="text" readonly></td></tr>
