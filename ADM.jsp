...
<body background="Images/backgrnd[2].gif" link="#669900" vlink="#999933" alink="#FF9900" leftmargin="1" topmargin="1" marginheight="1" marginwidth="1">
    ...
    <% 
String lid11=request.getParameter("lid22");    
String lpw11=request.getParameter("lpw22");
String lid15="";    
String lpw15="";
  try
      { 
...
ResultSet que1=state.executeQuery("select * from Register where RID='"+lid11+"' and RPass='"+lpw11+"'");
 if(que1.next())
{
            lid15=que1.getString("RID");
            lpw15=que1.getString("RPass");         
}
que1.close();
state.close();
con.close();
 ...
 <tr><td><img src="Images/airplane.gif" height="230" width="100%"></img> </td></tr>
     ...
     <tbody><tr><td>  
        ...
        <tbody><tr><td style="font-size: 20px;" align="center" height="auto" width="auto">
         <div  style="float:inherit;"><font face="Arial" color="violet" >
             <b>Airline Reservations Administrator Form</b>
    ...
    <tbody><tr><td colspan="2" bgcolor="violet">
        <div  style="color: white">
            <b>&nbsp;&nbsp;&nbsp;Welcome Administrator Page </b></div></td></tr></tbody></table></div>
  ...
  <%
 if(lid11.equals(lid15) || lpw11.equals(lpw15))
           {
    %>   
    <tr><td style="font-size: 15px;" valign="top"height="10" width="900">
           <font face="Arial" color="red" ><center>
               
                <a href="LogResv.jsp" style="text-decoration: none;">All Reservation</a>
                &nbsp;
                   <img src="Images/arrow_white_new.gif" title="Consolidators">  
                <a href="FI.jsp" style="text-decoration: none;">Flight Information</a>
                &nbsp;
                   <img src="Images/arrow_white_new.gif" title="Consolidators">     
                <a href="LogRT.jsp" style="text-decoration: none;">All Registration</a>
                &nbsp;
                   <img src="Images/arrow_white_new.gif" title="Consolidators">     
                   <a href="Home.html" style="text-decoration: none;">LogOut</a>
                &nbsp;
      ...
      <table valign="top" align="center" border="0" cellpadding="0" cellspacing="0" width="580">
        <tbody><tr><td> &nbsp;</td></tr>
         ...
         <div style="float:none;"><font face="Arial">
            <blink><b>Please Check Your ID And Password...</b></blink>
            </font></div></td></tr></tbody></table>        
     <%
   }
